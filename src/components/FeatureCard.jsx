...
export default function FeatureCard({ title, description, area, image, borderColor }) {
  return (
    <motion.div
      ...
      className={`${borderColor} border-secondary-cyan mb-8 max-w-[19.625rem] cursor-pointer rounded-lg border-t-4 bg-white p-8 shadow-lg shadow-blue-100 md:mb-0 xl:w-[21.875rem] xl:max-w-full`}
      style={{ gridArea: area }}
    >
